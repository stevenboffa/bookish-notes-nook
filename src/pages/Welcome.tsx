  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative pt-24 md:pt-16 min-h-[90vh] flex items-center justify-center overflow-hidden bg-white">
        <div className="absolute inset-0 bg-white">
          <div className="absolute inset-0 opacity-5" 
            style={{
              backgroundImage: `url("data:image/svg+xml,%3Csvg width='6' height='6' viewBox='0 0 6 6' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%230EA5E9' fill-opacity='0.4' fill-rule='evenodd'%3E%3Cpath d='M5 0h1L0 6V5zM6 5v1H5z'/%3E%3C/g%3E%3C/svg%3E")`,
            }}
          />
        </div>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -top-24 -left-24 w-96 h-96 bg-teal-light/40 rounded-full blur-3xl" />
          <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-peach-light/40 rounded-full blur-3xl" />
          
          <div className="absolute top-1/4 left-1/4 w-4 h-4 bg-teal/20 rounded-full animate-bounce-slow" />
          <div className="absolute bottom-1/4 right-1/3 w-3 h-3 bg-peach-dark/20 rounded-full animate-bounce-slow [animation-delay:500ms]" />
          <div className="absolute top-1/3 right-1/4 w-2 h-2 bg-primary/20 rounded-full animate-bounce-slow [animation-delay:1000ms]" />
        </div>
        ...
        <div className="container mx-auto px-4 py-10 md:py-16 lg:py-24">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="animate-fade-in max-w-xl">
              <div className="inline-block mb-6 animate-pulse">
                <div className="bg-teal text-white px-4 py-2 rounded-full font-bold text-sm flex items-center shadow-lg">
              ...
              <div className="relative z-10">
                <Button 
                  size="lg" 
                  className="h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg bg-primary text-white hover:bg-teal-dark shadow-lg hover:shadow-xl transition-all duration-200 group"
                  asChild
                >
          ...
          <div className="hidden md:block absolute -bottom-24 left-1/2 transform -translate-x-1/2 opacity-10">
            <div className="relative w-[500px] h-[500px] rotate-45 border border-teal/20 rounded-full">
              <div className="absolute inset-4 border border-primary/20 rounded-full" />
              <div className="absolute inset-8 border border-peach-dark/20 rounded-full" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-background relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-0 rounded-2xl overflow-hidden shadow-lg">
              <div className="bg-teal-light p-6 md:p-8 relative">
        ...
        <div className="absolute bottom-40 -right-20 md:-right-28 w-56 h-56 bg-peach/10 rounded-full blur-3xl" />
      </section>
      ...
      <section className="py-16 md:py-24 bg-muted/20 relative overflow-hidden">
        ...
        <div className="absolute top-1/3 -right-20 md:-right-28 w-56 h-56 bg-teal/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 -left-20 md:-left-28 w-56 h-56 bg-peach/5 rounded-full blur-3xl" />
      </section>

      {/* Features Section */}
      <section className="py-16 md:py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-white" style={{ opacity: 0.8 }}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10 md:mb-12">
              <Badge variant="outline" className="mb-4 px-4 py-1 border-teal/20 bg-teal-light text-teal font-medium">
                Powerful Features
              </Badge>
      ...
      {/* Steps Section */}
      <section className="py-16 md:py-24 relative overflow-hidden bg-peach-light">
        <div className="absolute inset-0 opacity-10" 
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='6' height='6' viewBox='0 0 6 6' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23F97316' fill-opacity='0.4' fill-rule='evenodd'%3E%3Cpath d='M5 0h1L0 6V5zM6 5v1H5z'/%3E%3C/g%3E%3C/svg%3E")`,
          }}
        />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10 md:mb-12">
              <Badge variant="outline" className="mb-4 px-4 py-1 border-peach-dark/20 bg-peach/20 text-peach-dark font-medium">
                Three Simple Steps
              </Badge>
            ...
            <div className="relative">
              ...
              <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-peach-dark/20 -translate-y-1/2 z-0" />
      ...
      {/* Testimonial Section */}
      <section className="py-16 md:py-24 bg-teal-light/50 overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button 
              size="lg"
              className="h-12 px-6 sm:px-8 text-base bg-primary hover:bg-teal-dark text-white"
              asChild
            >
              <Link to="/auth/sign-up">
      ...
      <footer className="py-12 md:py-16 border-t bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-lg font-bold mb-4 text-primary">BookishNotes</h3>
            ...
            <div>
              ...
              <Button 
                className="w-full bg-primary hover:bg-teal-dark text-white"
                asChild
              >
                <Link to="/auth/sign-up">
                  Create Free Account
...
const StepCard = ({ 
  ...
  <Card className="flex flex-col items-center text-center p-6 md:p-8 border-peach-dark/10 bg-white hover:shadow-lg transition-all duration-300 relative">
    <div className="absolute -top-5 bg-white border border-peach-dark/20 rounded-full p-1 shadow-lg">
      <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-peach-light flex items-center justify-center text-peach-dark font-bold text-lg md:text-xl">
        {number}
      </div>
    </div>
    
    <div className="mt-10 mb-3 text-4xl">{icon}</div>
    <h3 className="text-lg md:text-xl font-semibold mb-2 text-peach-dark">{title}</h3>
    <p className="text-sm md:text-base text-muted-foreground">{description}</p>
    
    <div className="h-1 w-20 bg-peach-dark/70 rounded-full mt-5"></div>
  </Card>
);
            ...
            <div className="flex-[0_0_100%] min-w-0 pl-4 md:pl-6" key={index}>
              <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md">
                ...
                <div className="flex items-center mt-6">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-teal-light rounded-full flex items-center justify-center text-teal font-bold">
